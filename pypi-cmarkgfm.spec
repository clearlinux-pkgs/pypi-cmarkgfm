...
Provides: cmarkgfm
Provides: cmarkgfm-python
Provides: cmarkgfm-python3
...
%prep
%setup -q -n cmarkgfm-0.7.0
cd %{_builddir}/cmarkgfm-0.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641423812
...
cp %{_builddir}/cmarkgfm-0.7.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-cmarkgfm/592ea524450874d50778dd5db4a8dd176a0261e2
cp %{_builddir}/cmarkgfm-0.7.0/third_party/cmark/COPYING %{buildroot}/usr/share/package-licenses/pypi-cmarkgfm/fa524e3e5b56232fdada455ba84c938f5a1487d2
