...
%prep
%setup -q -n cmarkgfm-2024.11.20
cd %{_builddir}/cmarkgfm-2024.11.20
pushd ..
cp -a cmarkgfm-2024.11.20 buildavx2
popd
pushd ..
cp -a cmarkgfm-2024.11.20 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732152338
